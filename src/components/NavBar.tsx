      ...
      {visible && (
        <>
            ...
            className={
              isOpen
                ? ` transition-all flex items-center justify-between p-6 ${
                  ...
                  } fixed w-full z-40 top-0 bg-transparent lg:w-auto  lg:bg-transparent lg:px-10`
                : ` transition-all flex items-center justify-between p-6 ${
                    previousScrollPosition == 0
                      ? "py-6 lg:bg-transparent sm:py-4 lg:py-5 xl:py-5"
                      : "py-3 lg:bg-transparent sm:py-1 lg:py-2 xl:py-2 "
                  } fixed w-full z-40 top-0 bg-ColorAzulMarinoOpaco lg:w-auto lg:px-10 `
            }
          >
            <Image
              src={
            ...
            <div
              className="flex flex-col gap-0 lg:hidden items-end justify-between w-10 h-6 z-30"
          ...
          <aside
            className={
              isOpen
                ? `fixed flex w-screen h-screen z-30 `
                : `hidden lg:flex z-30`
            }
          >
            <div
            ...
            <nav
              ...
              } lg:px-10 lg:fixed lg:bg-ColorAzulMarinoOpaco   lg:z-30`}
            >
