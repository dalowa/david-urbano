...
export default function HomeSec() {
  return (
    <section className="flex flex-col xl:flex-row xl:pt-20" id="Home">
      ...
      <div className="p-5 flex gap-3 pb-0 border-b-8 border-ColorA xl:w-1/2 justify-between xl:gap-2">
        <Image
          src={
          ...
          width={350}
          height={0o0}
          className="w-24 h-auto xl:w-96 xl:h-auto"
        />
        <div className="flex flex-col justify-center gap-10 items-center">
          <p className="text-ColorA font-SecondaryFont font-semibold w-60 text-right text-base pb-4 xl:text-4xl xl:w-auto xl:max-w-lg">
