...
export default function ContactSec() {
  return (
    <>
      <section
        id="Contact"
        className="bg-ColorAzulMarino py-32 min-h-screen flex flex-col items-center justify-center w-10/12 mx-auto gap-16 sm:gap-10 lg:gap-3 lg:w-10/12 xl:w-9/12 2xl:w-7/12 "
      >
